...
```
app/src/main/java/com/reconciliation/HelloController.java
```
...
**Important:** Replace the image placeholder `gcr.io/YOUR_PROJECT_ID/reconciliation:latest` with your actual GCR or Artifact Registry path.
